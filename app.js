...
function renderDashboard() {
    ...
    if (netProfit > 0) {
        ...
        } else if (hutang < netProfit) {
            healthStatus = "Sehat";
            healthColor = "#10b981";
        } else {
            healthStatus = "Waspada (Hutang > Untung)";
            healthColor = "#f59e0b"; // Warning Orange
        }
    } else if (netProfit < 0) {
        healthStatus = "Bahaya (Rugi)";
    ...
    if (dHealth) {
        dHealth.innerText = healthStatus;
